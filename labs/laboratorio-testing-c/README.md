...
> R:Falla el test. Esperaba 700 y obtuvo 350.
...
> R:Linea 24. Suma unicamente el valor unitario del producto.

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Multiplicar el precio unitario por la cantidad del mismo producto. Este valor esta en el struct del Producto.
...
> R:Falla, devuelve que espera 0 y obtiene 1. Informa del error stack smashing y aborta.
...
> R:El operador incorrecto es <=, deberia ser simplemente <
